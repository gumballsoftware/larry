...
//
//     On.hpp data = nlohmann::json::parse(jsonString);
...
namespace webthings {
    ...
    class On {
        ...
        bool & get_mutable_value() { return value; }
        void set_value(const bool & value) { this->value = value; }
        ...
        const std::string & get_on_type() const { return on_type; }
        std::string & get_mutable_on_type() { return on_type; }
        void set_on_type(const std::string & value) { this->on_type = value; }
        ...
        std::string & get_mutable_attr() { return attr; }
        void set_attr(const std::string & value) { this->attr = value; }

        const int64_t & get_attr_id() const { return attr_id; }
        int64_t & get_mutable_attr_id() { return attr_id; }
        void set_attr_id(const int64_t & value) { this->attr_id = value; }
